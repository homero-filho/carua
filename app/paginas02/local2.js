...
export default function Local1({ navigation }) {
   ...
   */
   ...
   const fetchAvaliacoes = async () => {
    try {
      setLoading(true);
const response = await api.get(`/avaliacoes/local/${LOCAL_ID}`);
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.infoContainer}>
        ...
        <Text style={styles.infoTexto}>Shopping Caruaru é o maior shopping do interior do Nordeste. Seu destaque se dá pela ampla variedade de lojas, opções de lazer e restaurantes.</Text>

        <Text style={styles.titulo2}>Localização:</Text>
        <Text style={styles.infoTexto}>• Av. Adjar da Silva Casé, 800 - Indianópolis, Caruaru - PE, 55024-740</Text>
